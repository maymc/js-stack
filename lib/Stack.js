...
class Stack {
    ...
    push(item){
        //Add or "push" item on top of stack.
        //The key is the current size, the value is the item
    ...
    pop(){
        ...
        if(this._size === 0){
            ...
            //Remove or "pop" item off stack
            //The key is length-1
            let poppedItem = this._storage[this._size - 1];
            this._size--;
            return poppedItem;
        }
